...
```bash
git clone https://github.com/Jason-SJC-hub/AIPM-Vibecoding-Skill.git ~/.codex/skills/vibe-coding-prd
```

Windows PowerShell 示例：

```powershell
git clone https://github.com/Jason-SJC-hub/AIPM-Vibecoding-Skill.git "$env:USERPROFILE\.codex\skills\vibe-coding-prd"
```
